...
## Character_Creation_Logic
Phase 1: Generate Core Attributes

1. Determine Combat Skill (CS)
- Action: Pick a random number from 0 to 9.
- Calculate: Add 10 to this number.
- Result: This is your starting CS

2. Determine Endurance Points (EP)
- Action: Pick a random number from 0 to 9.
- Calculate: Add 20 to this number.
- Result: This is your starting EP

Phase 2: Select Starting Book
- Choose a starting book from the list in the `Gamebook_Metadata` section

Phase 3: Select Kai Disciplines
1. Choose Initial Disciplines
- If the chosen book's subseries is `Kai`, choose 5 initial disciplines from `lone_wolf_skills.kai_disciplines` in the `Kai_Skills` section
- If the chosen book's subseries is `Magnakai`, choose 3 initial disciplines from `lone_wolf_skills.magnakai_disciplines` in the `Kai_Skills` section
- If the chosen book's subseries is `Grand Master`, choose 4 initial disciplines from `lone_wolf_skills.grand_master_disciplines` in the `Kai_Skills` section
